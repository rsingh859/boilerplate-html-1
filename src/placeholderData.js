...
import { imageObject } from "./images/data";
...
const Trainer1 = imageObject[5].url;
const Trainer2 = imageObject[6].url;
const Trainer3 = imageObject[7].url;
const Trainer4 = imageObject[8].url;
const Trainer5 = imageObject[9].url;
const Trainer6 = imageObject[10].url;
